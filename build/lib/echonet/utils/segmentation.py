...
def run(
    ...
    model.classifier1[-1] = torch.nn.Conv2d(model.classifier[-1].in_channels, 1,kernel_size=model.classifier1[-1].kernel_size)
    ...
    with open(os.path.join(output, "log.csv"), "a") as f:
        ...
        for epoch in range(epoch_resume, num_epochs):
            ...
            for phase in ['train', 'val']:
                ...
                ####################################################################################################################################################
                loss, loss_p, hd95_large,hd95_small,hd95_large_list, hd95_small_list, oks_l, oks_s, large_inter, large_union, small_inter, small_union = run_epoch(model, dataloader, phase == "train", optim, device)  #hd95_large, hd95_small,
        ...
        if run_test:
            ...
            for split in ["val", "test"]:
                ...
                loss, loss_p, hd95_large, hd95_small, hd95_large_list, hd95_small_list, oks_l, oks_s, large_inter, large_union, small_inter, small_union = echonet.utils.segmentation.run_epoch(model, dataloader, False, None, device)
                ...
                with open(os.path.join(output, "{}_dice.csv".format(split)), "w") as g:
                    ...
                    for (filename, overall, large, small, hd_l, hd_s) in zip(dataset.fnames, overall_dice, large_dice, small_dice, hd95_large_list, hd95_small_list): #zip用于将多个迭代器对象打包成一个元组序列
                        g.write("{},{},{},{},{},{}\n".format(filename, overall, large, small, hd_l, hd_s))
